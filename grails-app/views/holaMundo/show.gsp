	...
	<body>
		...
		<div id="show-holaMundo" class="content scaffold-show" role="main">
			...
			<ol class="property-list holaMundo">
				...
				<g:if test="${holaMundoInstance?.frase}">
				<li class="fieldcontain">
					<span id="frase-label" class="property-label"><g:message code="holaMundo.frase.label" default="Frase" /></span>
					
						<span class="property-value" aria-labelledby="frase-label"><g:fieldValue bean="${holaMundoInstance}" field="frase"/></span>
