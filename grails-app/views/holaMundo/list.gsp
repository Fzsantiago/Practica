			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="frase" title="${message(code: 'holaMundo.frase.label', default: 'Frase')}" />
				...
				<g:each in="${holaMundoInstanceList}" status="i" var="holaMundoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${holaMundoInstance.id}">${fieldValue(bean: holaMundoInstance, field: "frase")}</g:link></td>
